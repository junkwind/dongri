...
//rpc/blockchain.cpp:131:45: error: invalid initialization of reference of type ‘const CTransaction&’ from expression of type ‘const value_type {aka const std::shared_ptr<const CTransaction>}’
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "blockchain",         "getblockdeltas",         &getblockdeltas,         false, {"getblockhash"} },
