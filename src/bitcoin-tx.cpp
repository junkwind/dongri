...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dongri-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dongri-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dongri transaction") + "\n" +
              "  dongri-tx [options] -create [commands]   " + _("Create hex-encoded dongri transaction") + "\n" +
              "\n";
